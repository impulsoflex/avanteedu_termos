  ...
  return (
    <div className="content">
      ...
      <p>
        <span>
          Ao acessar ao site
          <a href="https://termos.avanteedu.com.br">Avante Educacional</a>,
      ...
      <p>
        <span>
          ...
          materiais (informações ou software) no site Avante Educacional ,
      ...
      <ol>
        ...
        <li>
          <span>
            ...
            contido no site Avante Educacional;&nbsp;
          </span>
        </li>
        <li>
          <span>
      ...
      <p>
        <span>
          ...
          dessas restrições e poderá ser rescindida por Avante Educacional a
      ...
      <ol>
        <li>
          <span>
            Os materiais no site da Avante Educacional são fornecidos &apos;como
            estão&apos;. Avante Educacional não oferece garantias, expressas ou
        ...
        <li>
          <span>
            Além disso, o Avante Educacional não garante ou faz qualquer
      ...
      <p>
        <span>
          Em nenhum caso o Avante Educacional ou seus fornecedores serão
          ...
          decorrentes do uso ou da incapacidade de usar os materiais em Avante
          Educacional, mesmo que Avante Educacional ou um representante
          autorizado da Avante Educacional tenha sido notificado oralmente ou
      ...
      <p>
        <span>
          Os materiais exibidos no site da Avante Educacional podem incluir
          erros técnicos, tipográficos ou fotográficos. Avante Educacional não
          garante que qualquer material em seu site seja preciso, completo ou
          atual. Avante Educacional pode fazer alterações nos materiais contidos
          em seu site a qualquer momento, sem aviso prévio. No entanto, Avante
          Educacional não se compromete a atualizar os materiais.
        </span>
      </p>
      <h2>
        <span>6. Links</span>
      ...
      <p>
        <span>
          O Avante Educacional não analisou todos os sites vinculados ao seu
          site e não é responsável pelo conteúdo de nenhum site vinculado. A
          inclusão de qualquer link não implica endosso por Avante Educacional
      ...
      <p>
        <span>
          O Avante Educacional pode revisar estes termos de serviço do site a
      ...
      <p>
        <span>
          ...
          leis do Avante Educacional e você se submete irrevogavelmente à
