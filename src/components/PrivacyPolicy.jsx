const PrivacyPolicy = () => {
  return (
    <div className="content">
      ...
      <p>
        <span>
          A sua privacidade é importante para nós. É política do Avante
          Educacional respeitar a sua privacidade em relação a qualquer
          informação sua que possamos coletar no site
          <a href="https://termos.avanteedu.com.br">Avante Educacional</a>, e
      ...
      <p>
        <span>
          ...
          delas para lhe fornecer um serviço. Fazemos-lo por meios justos e
      ...
      <p>
        <span>
          ...
          informação que o Avante Educacional oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          <span>
            ...
            (softwares) do Avante Educacional, de seus fornecedores ou
